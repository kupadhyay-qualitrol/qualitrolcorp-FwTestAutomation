...
function ImportConfigurationAsTemplate()
{
  ...
  AssertClass.IsTrue(ConfigEditor_ConfigurationPage.SelectTemplateFromTemplateList(),"Selected template from the template list")
...
function ImportConfigFromOtherDevice()
{
  ...
  AssertClass.IsTrue(ConfigEditor_ConfigurationPage.SelectDeviceFromImportOtherDevice(),"Selected device from the device list")
